...
<div id="container">
    ...
    <div id="content">
        <c:if test="${!empty sessionScope.SPRING_SECURITY_LAST_EXCEPTION}">
            ...
            <p class="error">Your login attempt was not successful.
        ...
        <authz:authorize ifNotGranted="ROLE_USER">
            ...
            <p>Tonr.com has only two users: "marissa" and "sam". The password for "marissa" is password is "wombat" and
                for "sam" is password is "kangaroo".</p>
